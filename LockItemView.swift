...
extension LockItemView {
  ...
  private func directFlag(ctx: CGContextRef, rect: CGRect) {
  ...
  private func propertySetting(ctx: CGContextRef) {
    CGContextSetLineWidth(ctx, CoreLockArcLineW)
    (isDefaultColor ? kColorItemError : kColorItemNormal).set()
  }
  
  private func circleNormal(ctx: CGContextRef, rect: CGRect) {
